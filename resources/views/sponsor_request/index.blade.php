        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="{{ route('sponsor-request.history') }}" class="card-link">Riwayat</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="sponsor-table" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>Jenis Sponsor</th>
                                <th>Jumlah Rupiah</th>
                        ...
                        <tbody>
                            @foreach($requests as $request)
                                <tr>
                                    ...
                                    <td>Rp.{{ number_format($request->jumlah_rupiah, 0, ',', '.') }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('sponsor-request.edit', $request) }}">{{ $request->status }} <i class="mdi mdi-pencil"></i></a>
                                    </td>
                                    <td>
