                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="delete-form-{{ $detail->id }}" action="{{ route('invoicecustomer.delete_product', ['id' => $detail->id]) }}" method="post">
                                        @csrf
                                        <input type="hidden" name="_method" value="DELETE" class="form-control">
                                        <button class="btn btn-danger btn-sm delete-product-btn" data-id="{{ $detail->id }}" onclick="deleteProduct(event)">Hapus</button>
                                    </form>
