...
<head>
    ...
    <title>Invoice Non PPN - Customer</title>
    ...
    <div class="container">
        <table>
            ...
            <thead>
                ...
                <tr>
                    <th colspan="1" align="left">Invoice <strong>#{{ $invoicecustomer->no_faktur}}</strong></th>
        ...
        <Table>
            <thead>
                <tr>
                    ...
                    {{-- <p align="right">
                        ...
                        Bantul, DI. Yogyakarta. Telp/Fax (0274) 4436047
                    </p> --}}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">{{ $invoicecustomer->no_faktur}}</td>
    ...
    <div class="page_break">
        <table>
            <tr>
                ...
                <p align="center" style="font-size: 14px; margin:5px">No. {{ $invoicecustomer->no_faktur}}</p>
                ...
                <?php 
                    ...
                    <p align="left" style="font-size: 14px; margin:5px">Guna Membayar &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;Pembayaran Faktur No. {{ $invoicecustomer->no_faktur }}&nbsp;&nbsp;&nbsp;Tanggal Faktur {{ $invoicecustomer->created_at->format('D, d M Y') }}</p><hr align="right" width="80%">
    ...
    <div class="page_break">
        <table>
            ...
            <th colspan="3">
                ...
                <p align="center" style="font-size: 12px;">No. {{ $invoicecustomer->no_faktur}}</p>
