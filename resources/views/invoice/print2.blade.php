        ...
        <Table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align ="center"> {{ \Carbon\Carbon::parse($invoice->tenggat)->locale('id_ID')->isoFormat('dddd, D MMM YYYY')  }}</td>
        ...
        <table>
            ...
            <tr>
                ...
                <?php 
                    ...
                    <p align="left" style="font-size: 14px; margin:5px">Guna Membayar &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;Pembayaran Faktur No. {{ $invoice->no_faktur_2023 }}&nbsp;&nbsp;&nbsp;Tanggal Faktur  {{ \Carbon\Carbon::parse($invoice->created_at)->locale('id_ID')->isoFormat('dddd, D MMM YYYY')  }}</p><hr align="right" width="80%">

                    <p align="left" style="font-size: 14px; margin:5px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;Tanggal Jatuh Tempo  {{ \Carbon\Carbon::parse($invoice->tenggat)->locale('id_ID')->isoFormat('dddd, D MMM YYYY')  }}</p><hr align="right" width="80%">
     ...
     <div class="page_break">
        ...
        <table>
            ...
            <th colspan="3">
                ...
                <p align="center" style="font-size: 12px;">No Invoice. {{ $invoice->no_faktur_2023}}</p>
