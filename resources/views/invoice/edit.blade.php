...
@section ('header')
    ...
    <div class="appHeader bg-purple text-light">
        ...
        <div class="pageTitle" style="font-size: 12px">DETAIL ORDER {{ $invoice->customer->name }}</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                            ...
                            <div class="col-md-6 mb-4 mr-2">
                                ...
                                <form action="{{ route('invoice.update', ['id' => $invoice->id]) }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="product_detail_id" id="product_ajax" class="form-control">
                                ...
                                <a href="/menuinvoice" class="btn btn-success btn-block">Selesai</a>
