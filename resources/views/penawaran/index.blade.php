                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-bordered" id="penawaran-table" class="table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <!-- DIRECTIVE FOREACH SAMA DENGAN FORELSE -->
                                <!-- HANYA SAJA SUDAH FOREACH SUDAH DILENGKAPI FUNGSI UNTUK MENGECEK DATA ADA ATAU TIDAK SEHINGGA KITA TIDAK PERLU LAGI MENGGUNAKAN IF CONDITION -->
