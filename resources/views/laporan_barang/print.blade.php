...
<div style="text-align: left;">
    <img align="left" src="{{ asset('assets/images/ptlmi.jpg') }}" alt="" style="width: 175px; height: 40px; ">
    <div class="row" style="display: inline-block; text-align: left; margin-left:60px;">
