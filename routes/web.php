...
Route::get('/bahanmentah', [BahanMentahController::class, 'index'])->name('bahanmentah.index');
Route::get('/bahanmentah/edit/{id}', [BahanMentahController::class, 'edit'])->name('bahanmentah.edit');
Route::get('/bahanmentah/create', [BahanMentahController::class, 'create'])->name('bahanmentah.create');
...
Route::group(['middleware' => ['auth', 'ceklevel:logistik']], function () {
